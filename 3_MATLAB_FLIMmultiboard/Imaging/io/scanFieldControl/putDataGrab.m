function putDataGrab
	...
	if state.acq.createLineClock %gy 201204 && ~(state.acq.dualLaserMode==2) % skip if alternating lasers gy 20101129
		pcellChannels=[pcellChannels state.acq.lineClockIndex state.acq.frameClockIndex];
	end
