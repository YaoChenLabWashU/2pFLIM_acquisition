...
% commented to change to slice analysis. spc_WriteToExcelCOM(0,0,state.cycle.currentCyclePosition);
for counter=1:state.acq.numberOfZSlices;
    spc_WriteToExcelCOM(0,0,counter);
    spc.analysis.excelNextCol=spc.analysis.excelNextCol+counter-1;
    rng=spc_WriteToExcelCOM(0,0,spc.meanTau{counter}); rng.NumberFormat='0.00';
