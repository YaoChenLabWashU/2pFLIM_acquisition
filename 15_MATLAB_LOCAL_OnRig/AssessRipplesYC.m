...
for k=1:1; 
    sum(spc.lifetimes{k}) % printing photon counts/s (5s in this case).
    gy(1,k)=1/sqrt(mean(spc.lifetimes{k}(10:243)));
    gy(2,k) =std(spc.lifetimes{k}(25:195))/mean(spc.lifetimes{k}(10:243)); 
