function varargout=appendimage(wv,varargin)
...
for waveCounter=1:length(waveCell)
	...
	h=image(get(waveName, 'data'), 'Parent', ax, 'UserData', UserData,'XData', makeXData(waveName), 'YData', makeYData(waveName), 'Tag', waveName);
