...
% CYCLEGUI Application M-file for cyclegui.fig
%    FIG = CYCLEGUI launch cyclegui GUI.
%    CYCLEGUI('callback_name', ...) invoke the named callback.

% Last Modified by GUIDE v2.0 02-Sep-2002 10:44:51
