function ivAutoSetSpineBox(objects, timePoints)
	...
	for timePoint=timePoints
		...
		for objectNumber=objects
			...
			bm=roipoly(state.imageViewer.nPixelsY, state.imageViewer.nPixelsX, ...
...
% 					sliceData = state.imageViewer.projectionIndexData{state.imageViewer.morphChannel}...
			...
			rd=state.imageViewer.tsCoredFlatProjection{state.imageViewer.tsFileCounter, state.imageViewer.morphChannel}...
					(1:state.imageViewer.nPixelsY, 1:state.imageViewer.nPixelsX)>=thresh & bm;
			state.imageViewer.tsSelectedMask{state.imageViewer.tsFileCounter, state.imageViewer.morphChannel}(rd)=100;
